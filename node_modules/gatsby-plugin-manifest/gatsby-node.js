            ...
            return Promise.all(locales.map(function (locale) {
              ...
              */
              ...
              return makeManifest({
                cache: cache,
                reporter: reporter,
                pluginOptions: (0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({}, manifest), locale), cacheModeOverride),
                shouldLocalize: true,
                basePath: basePath
              });
            }));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            if (pluginOptions.icon_options) {
              manifest.icons = manifest.icons.map(function (icon) {
                return (0, _extends2.default)((0, _extends2.default)({}, pluginOptions.icon_options), icon);
              });
          ...
          case 32:
            ...
            manifest.icons = manifest.icons.map(function (icon) {
              return (0, _extends2.default)((0, _extends2.default)({}, icon), {}, {
