...
\n`;
  asyncRequires += `exports.components = {\n${components.map(c => {
    ...
    const relativeComponentPath = _path.default.relative(_path.default.join(program.directory, `.cache`), c.component);
...
const debouncedWriteAll = _lodash.default.debounce(async () => {
  ...
  activity.start();
  const didRequiresChange = await writeAll(_redux.store.getState());
