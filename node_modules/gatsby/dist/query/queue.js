...
const createBuildQueue = (graphqlRunner, runnerOptions = {}) => {
  ...
  const handler = ({
    job,
    activity
  }, callback) => queryRunner(graphqlRunner, job, activity === null || activity === void 0 ? void 0 : activity.span).then(result => callback(null, result)).catch(callback);
...
const createDevelopQueue = getRunner => {
  ...
  const handler = ({
    ...
    queryRunner(getRunner(), queryJob, activity === null || activity === void 0 ? void 0 : activity.span).then(result => {
      if (queryJob.isPage) {
