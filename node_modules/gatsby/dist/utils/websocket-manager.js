...
class WebsocketManager {
  constructor() {
    (0, _defineProperty2.default)(this, "activePaths", new Set());
    (0, _defineProperty2.default)(this, "connectedClients", 0);
    (0, _defineProperty2.default)(this, "errors", new Map());
    (0, _defineProperty2.default)(this, "pageResults", new Map());
    (0, _defineProperty2.default)(this, "staticQueryResults", new Map());
    ...
    (0, _defineProperty2.default)(this, "getSocket", () => this.websocket);
    (0, _defineProperty2.default)(this, "emitStaticQueryData", data => {
    ...
    (0, _defineProperty2.default)(this, "emitPageData", data => {
    ...
    (0, _defineProperty2.default)(this, "emitError", (id, message) => {
      if (message) {
